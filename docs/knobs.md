...
cloudchamber draw, POST /api/draws, and the Voice Bridge draw tool take the same knobs.
...
| `repair` | auto: up to 4 rounds, accepting findings scoring 6+, patience 2, budget 120 calls |
