...
`docs/knobs.md` lists every tunable — the settings and their domain slugs,
the genre shortcuts, the sampling modes, the sources, the drafting defaults
and the model per stage. It is generated: run `fogbelt help` for the same
thing live, or `fogbelt help --md > docs/knobs.md` after changing a setting
