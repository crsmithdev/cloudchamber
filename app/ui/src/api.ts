...
export const api = {
  ...
  runs: () => j<Run[]>("/api/runs"),
  run: (id: string) => j<{ run: Run; steps: Step[]; artifacts: Artifact[]; candidates: Candidate[]; examples: Example[] }>(`/api/runs/${id}`),
