...
const STAGE: Record<string, { name: string; does: string }> = {
  ...
  outline: { name: "derive outline", does: "Derives the chosen vignette's structure: its one departure from the actual, the particulars the prose must keep to, and who knows what." },
  ...
  ending: { name: "write ending", does: "Writes the last beat from the outline's particulars and who knows what." },
