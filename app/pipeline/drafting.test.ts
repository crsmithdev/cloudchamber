...
describe("templates and store", () => {
  ...
  test("a version-3 store migrates to 6: finding and draft verdicts, repaired_from, draft_config, tools, forked_from, sampling", () => {
    ...
    expect(db.query("SELECT repaired_from, draft_config, forked_from, sampling FROM draws WHERE id = 'r1'").get()).toEqual({ repaired_from: null, draft_config: null, forked_from: null, sampling: "tail" });
