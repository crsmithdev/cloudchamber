...
| file | what it is |
| :-- | :-- |
| `drafting.md` | what comes after a plan — that checking is reliable on a scene and falls to chance on a story, that a ledger beats a reader, that feedback misses the biggest issue unless asked for it, that a beat schedule closes half the tension gap, that machine fiction is recognisable by structure, that polishing removes voice |
