...
| `generation.md` | why a generation call is shaped the way it is — mode collapse and where it comes from, what raises output diversity and by how much, why negations decay with distance from the ask, why exemplars beat instructions on register |
