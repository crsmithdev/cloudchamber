# Fog Belt — Reference Distillate (working playbook)
...
*Twelve families. Deduped. Each line is a premise seed, not a description.*
...
*What actually makes it cold. Ten families.*
...
*Containers proven to work. Ones already used on the Fog Belt slate are marked.*

**Used:** quarterly check-in series · new-hire training curriculum · audit walkthrough · dive log · vesting schedule.
...
For generating or auditing in fifteen minutes.

1. **Pick the apparatus, not the anomaly.** A setting-a institution with a founding date, a cover story, a rate card, and a schedule. What does it *do* every week?  
2. **Pick one theme family (§1).** State it as a mechanism with units, not a mood.  
...
10. **Write the last line.** One beat past the horror, small, administrative, correctly filed. If you can't find it, the ending isn't earned yet.  
11. **Name the bell.** The recurring sound that marks the schedule.
...
**Withholding as content** — djkaktus: SCP-2933, SCP-2740. Chiang: *Division by Zero*.
