...
**Where the evidence lives:** `reference-chiang-and-watts.md` · `reference-setting-c-and-setting-b.md` · `reference-neon-genesis-evangelion.md` · `reference-julian-jaynes.md` · Annexes C1–C6, the djkaktus corpus (`reference-djkaktus-*.md`) · Annex F, eighteen assorted SCP articles (`reference-scp-assorted.md`) · the standalone on SCP-8980 (`reference-scp-8980-ergophobia.md`) · sixty-three triaged but unregistered articles (`reference-scp-candidates.md`) · the slate itself (`ideas-v2.md`, 24 stories) · what has been cut from this document and why (`reference-distillate-cuts.md`).
...
*Descriptive, not prescriptive. Configurations the corpus has actually used. Stories routinely run two at once, and the best ones have found a shape that isn't here yet. Coverage story-by-story is in `reference-distillate-cuts.md`.*
...
One impossibility, bought honestly, and everything downstream is arithmetic. Watch for a second one smuggled in to escape a corner.

**Ask:** what does this premise make cheap that used to be expensive? Who arbitrages that? What does the trade press say about it in year twelve? What is the exception process, and who was denied?

*Dwell Time* spends exactly one and buys the rest with dose response. *Second Circulation* declines the question outright — aliens are permitted there. SCP-9138 spends one (a filterfeeding technique discovered on 14 June 1950) and gets a new moral law for the universe eleven days later, with grave-robbing as the containment procedure. `[S]`

### Watts — find where the self stops being necessary

Strong form: *the ones without selves outperform the ones with them, the data supports it, and the market noticed.* Not required — a story can be institutional horror only and be fine.

**Ask:** who noticed first, and what did the returns look like afterwards? What is the line item that used to be a person?

The wider vein: consciousness kept alive because it is load-bearing infrastructure rather than out of cruelty — SCP-439 leaves parts of the brain intact for metabolic efficiency, and the eyes still track. `[S]`

### setting-b — make the institution correct, not deluded

If the metaphysics is materially true, the institutions built on it are correct. Nobody is a fanatic; everybody is a ratepayer. Inapplicable where there is no metaphysics — several of the strongest stories are entirely mundane by design.

**Ask:** what is the bond measure called? Who audits it? What does the ethics body approve, and what does it approve *instead*?
...
Where there is an artifact: does it exist to *do a job*, or to tell the story? An artifact that exists to narrate is a testimony wrapper.

Document-as-monster is at or near capacity. Having no document at all is now a legitimate answer — *Second Circulation*'s monologue has no addressee, and that absence is the complicity. So is having a document that is the wrong kind: captioned photographs with no narration `[S]` (SCP-9377), a table of five endorsements `[S]` (SCP-9138), a recruitment standard standing where a procedure should be `[S]` (SCP-231).

**Ask:** who filed this, to satisfy what requirement, and what would happen to them if they hadn't?

### Evangelion — check whether the instrument is a person

If the terrible thing could be done by a machine instead, it is engineering. If it requires a specific person, and the paperwork for using them is complete and correct at every step, it is this register.
...
- **Institutions can be the villain.** *(A1, 2026-08-26 — supersedes "no villains".)* The default remains that cruelty is a byproduct of somebody's reasonable programme and the programme is working. But a straight reading in which the institution simply *is* the antagonist is available and does not need laundering through arithmetic. **The reveal does not always have to exonerate.** What became optional is the exoneration, not the rigour — see the anti-pattern in §5.
- **The narrator is good at their job and warm.** *(A4, 2026-08-27 — one narrator is a default, not a constraint.)* Multi-voice and multi-register structures are available where the premise requires them, and some premises do: if the loss the story describes is a loss of the faculty needed to notice it, anyone who can narrate it clearly is by definition from before it, and one voice cannot carry the piece. The requirement applies to each voice. Every voice must be doing a real job in a real document, and must be warm, articulate and convinced it is fine.
...
*Thirteen families. Deduped. Each line is a premise seed, not a description.*
...
- Personality as removable machinery, and personhood as what's left when you remove it. `[K]`
- The mutilated originals still want what they were built to want; their own desire is the cage. `[K]`
...
- Annihilation without the dignity of death: being *unwritten* and someone else written in your place. `[K]`
...
- The debt that is unpayable by definition, and grows regardless of payment, so effort itself is the trap. `[K]`
- Suffering as a currency — spendable, transferable, drawn at range off your own people. `[TC]`
- Human beings as consumable hardware inside somebody's supply chain, with an invoice. `[K]`
- Grace with an inventory cap, a wholesale rate, a black market, and counterfeits. `[TC]`
- The founding blasphemy: the institution's greatest triumph built on a mass grave nobody kept. `[K]`
...
- Inherited containment — current staff perpetuating a dead man's crime because the alternative is worse. `[K]`
- Maintenance as morality: the ethical question replaced by a repair schedule. `[K]`
- Duty outliving the institution that assigned it. Loyalty with no employer left. `[K]`
- Nothing is permitted to finish. The dead keep working. `[setting-c]`
- A failing power supply with a visible, audible countdown, and a Thaumiel classification that means *the only thing between you and it is already dying*. `[K]`
...
- Memory as a shared, leaking substance. Not amnesia — cross-contamination. You keep having a life; it stops being yours. `[K]`
- The institution's memory-erasure apparatus revealed to run on ground-up people. `[K]`
- Precision against rightness: written accuracy delivers the first while destroying the second. `[C]`
- Amnestics that fail in the worst direction — the terror stays, the cause is deleted. `[K]`
...
- Care as capture: the predator arrives as the only person who was ever kind to you. `[K]`
- Grooming rendered as kindness — a gentle correction, twice, and the child learns which answer is *blue*. `[K]`
...
- Reproductive coercion made institutional: a bureaucracy that farms a human condition as a renewable resource. `[K]`
...
- Staying at your post as the specific moral texture — careers measured in funerals not attended. `[K]`
- The appalling decision as the correct one available. `[TC]` `[K]`
- Bureaucratic cruelty arrived at one reasonable step at a time; no one in the file is a sadist. `[K]`
- Institutional triage: containing the infected rather than the infection, and calling it a plan. `[K]`
- Complicity by delegation — the institution didn't invent the system, it *inherited* it and made it efficient. `[K]`
- The ethics body that reviews atrocities and approves the slightly milder one, then bans testing after all the data is in. `[K]`
- Escape hatches, one per act, each closed by the end. `[K]`
...
- The anomaly's signature is absence: things that did not happen, remembered clearly. `[K]`
- A dread with no object — the fear confirmed, the thing never. `[K]`
- Something taken out of every mind, with no way to feel its absence. `[K]`
- Estrangement literalised: the person who left so completely that they never were. `[K]`
- Hell redefined as pure privation, and more terrifying for having no content. `[C]`
- The most consequential event in the file delivered as a blank — a reclassification, an expunged result, a truncated log. `[K]`
- Existential deflation: the last frontier is a wall, and reaching it kills the part of you that wanted to go. `[K]`
...
- Mission inverted — not concealing the anomaly from the public but concealing the public from the anomaly. `[K]`
- Documentation as compulsion: an organisation that cannot stop writing files even with nothing to file. `[K]`
...
- Reproduction weaponised — the atrocity is that it works and cannot be outpaced. `[K]`
- The family as the unit of evil; no recruitment, only descent. `[K]`
- Three-generation transmission of one man's idea as inheritable damage. `[C]`
- Sins of the fathers as literal causation: every monster downstream of one act of cruelty to one prisoner. `[K]`
- Maternal attachment as the thing that makes the sacrifice unbearable rather than easier. `[K]`
...
- Grief as an aperture — the apparatus recruits the recently bereaved. `[K]`
- Love as a security vulnerability; the thing wins because someone needs the dead to still be in there. `[K]`
...
- A promise kept past all reason as both devotion and curse. `[K]`
- Grief that outlives every party to it, including the griever's species. `[K]`
...
*The toolkit. Seventy-eight named moves in seven families. Numbers are stable handles, not an order of preference — M1–M55 keep the numbering they have always had, and the Annex F additions run from M56. M27 was withdrawn on 2026-08-28 — see `reference-distillate-cuts.md`.*

### 2.1 Container — choosing the form

- **M1. The form is the story.** Pick the container because it is the only shape in which that idea can be felt. A journal editorial, a museum label, a training module, a rulebook, a prisoner manifest, a facility dossier, a testament to a posthumous reader. `[C]` `[K]`
- **M2. The operating manual first.** Draft the checklist, rate card, escalation taxonomy, aftercare policy — then let the listener supply the revulsion. `[K]`
- **M3. The procedure is the monster.** Flat administrative prose whose implications the document declines to notice. A bureaucracy's characteristic evil is the passive voice. `[K]`
- **M4. Read the horror before the monster.** Put the containment procedure at the top, in policy register, so the audience only understands what each bullet cost after the fact. `[K]`
- **M5. The trigger documentation.** State the rules so clearly that the audience understands exactly how they will be broken — and then make them wait. `[K]`
...
- **M9. The document is a bad witness.** Footnotes that contradict the body. Two sources that disagree. A memo declaring half of what precedes it obsolete. Confidently wrong beats ominous. `[setting-c]` `[K]`
...
- **M11. Never describe the worst thing.** Refusing to transcribe is better than any transcript: whatever they supply is worse than what you'd write. `[K]`
...
- **M13. The blank as the climax.** Expunged results, truncated logs, an outcome reported only as a classification change. `[K]`
- **M14. The locked option.** The one function you cannot see is the one that matters. `[K]`
- **M15. The single unexplained detail.** A sound, a phrase, a cat noise, a stopped watch — meaning nothing, explaining nothing, and worse for it. `[K]`
- **M16. Underwrite the perpetrator.** No journals quoted, only the phrase "his daughter." Force the reconstruction. `[K]`
...
- **M18. The lie never disclosed.** The title, the central mystery, and the emotional weight can all rest on information withheld permanently. `[K]`
- **M19. Refuse to escalate.** Sometimes there is no addendum, no exploration log, no thing in the dark. The refusal *is* the move, and it's rare. `[K]`
...
### 2.3 Escalation and structure

- **M20. Escalate by revision, not narration.** Addenda, updated memoranda, transferred jurisdiction, revoked clearances. The audience watches an institution *learn*. `[K]`
- **M21. The ladder.** Each section written from one rung higher than the last — clinical file, worried memo, rejected theory, event log, a message from the author. `[K]`
- **M22. Escalation driven by legitimate curiosity.** Every test asks a reasonable next question; each reasonable next question is more monstrous. `[K]`
- **M23. The countdown as exposition.** Five dated machine-voice lines. A percentage with an acceleration curve. A ten-year failure estimate. Give them arithmetic to do. `[K]`
...
- **M25. Three registers that solve each other.** Bureaucratese, a live transcript, a failing witness's interview. None explains the anomaly; the audience assembles it. `[K]`
- **M26. The reveal as reinterpretation, not information.** Everything is visible from paragraph one; only the meaning inverts. `[K]`
...
### 2.4 Voice and register

- **M31. Give the format a person.** One consistent human voice intruding on institutional prose does more than pages of interiority. `[K]`
- **M32. The warm professional.** Every line reasonable, collegial, engaged — which is what makes it unbearable. Never give the thing a villain's voice. `[K]`
- **M33. The narrator with no access to his own interior.** Not lying — structurally unable to report himself. `[W]`
- **M34. Damn them in their own affectionate voice.** They never use the word they should. `[K]`
...
- **M40. One beat past the horror,** on something small, administrative, or domestic, correctly filed. `[K]`
- **M41. The marginal note.** Four words in different handwriting carrying the entire moral weight. `[K]`
- **M42. The last register is exhaustion, not shock.** A director's plain, unheroic declaration. `[K]`
- **M43. The final line that detonates the document,** including the audience's sympathies. `[K]`
- **M44. The ending as growth, not resolution.** The thing stretched; the only response available is a request for reclassification. `[K]`
- **M45. Nested false endings** that each recontextualise the last, closing on a question rather than a fact. `[K]`
...
### 2.6 The instrument and the operator
...
*What actually makes it cold. Eleven families.*
...
- Contagion by knowledge: the file is the vector, and reading to the end is participation. `[K]`
- The precaution described at the top is one they have already failed. `[K]`
...
- Predation without malice: nothing hates you; you're inventory. `[K]`
- Immune response, not attack. You are not being murdered, you are being cleaned up. Malice would be flattering. `[W]`
- Optimisation without grievance — no negotiation available because there is nothing to negotiate. `[K]`
- Cosmic indifference: Earth is a work order. `[K]`
...
- The model was accurate — they got it right, that's the problem. `[K]`
...
- The dread is duration. She will be on that cliff on every full moon indefinitely. `[K]`
- Persistence without release — being killed does not end you, being vaporised does not end you. `[K]`
- Immortality as the sentence, not the reward. `[K]`
- Slowing thought means the end is never perceived as an end. There is no last moment. `[C]`
- A fire people cannot die in, cannot be reached in, and can only be counted by their voices. `[K]`
- Ten thousand years in the fire — a sentence, which implies a court, which implies a keeper counting. `[K]`
...
- The procedure itself: a sedated person in a diving suit, towed out and unclipped, and every dose of the product traces back to it. `[K]`
- A recurring liturgy written down, approved, and repeated weekly, in which an adult stands beside a child and recites. `[K]`
- The most frightening sentence available is a capacity figure. `[TC]`
- Repetition designed so no one accumulates enough memory to refuse. `[K]`
- A god that cannot be fought, only starved, and the institution cannot stop feeding it. `[K]`
...
- Bureaucratic politeness persisting into apocalypse. `[K]`
- A cheerful voice, sincerely trying to help, describing the planet's core as a logistics problem. `[K]`
- The transaction's lightness against the outcome's weight — a doomsday weapon bought over email with follow-up questions. `[K]`
...
- The predator arrives as the only person who was ever kind to you. `[K]`
- Mercy as the delivery mechanism — the dormant mind filled with hymns immediately before the trigger word. `[setting-c]`
- Transformation the subject welcomes; nobody in the file is suffering, which is the point. `[K]`
- The benefit is real and never revoked, and that refusal to reveal a catch is worse than a catch. `[K]`
- Warm the whole time, aimed at nothing. `[C]`
- The specific social horror of a small kindness converting you into someone's permanent resource. `[K]`
...
- An object nearly everyone has physically held. A student loan letter. A keychain. A cereal box. `[C]` `[K]`
- The banality of the venue: nothing gothic. A fast-food restaurant off a state road. `[K]`
- A voicemail log presented as an evidence index — durations, document types, *Status: Could not connect* — and it is the most upsetting section in the file. `[K]`
- The trigger is an ordinary news item. No breach, no villain. `[K]`
- Ten calls to Momma, none connecting. The most human line is a row in a table. `[K]`
- It sits in a low-security locker, and personnel plug it in voluntarily, at half past eight, because they like it. `[K]`
...
**Facility dossier** — founding date, cover story, wings marked *Unspecified*, staffing table. Inherits a whole world for free. `[K]`

**Prisoner or asset manifest**, with a personal note from the keeper. An alien filing system carrying all the characterisation. `[K]`

**Optimisation guide / rulebook / difficulty settings.** Twenty thousand enjoyable words whose win condition is a child dying on schedule. `[K]`

**Compulsory training module** with the listener's name in it and a supervisor grading comprehension. The form is the anomaly. `[K]`
...
**Voicemail sequence** — one voice, one arc, no narrator. Six messages, and the sixth collects. `[K]`

**Correspondence chain or paper trail.** Escalation happening entirely in someone's typing. `[K]`

**Ordnance inventory or rate card.** The deaths deduced from the line items. `[K]`

**Vote-length column, correlation table, capacity figure.** An entire moral position with no editorialising. `[K]`
...
## Quick lookup — who is strongest on what
...
**Sixty-three further candidates, triaged and unregistered** — `reference-scp-candidates.md`. Tier 1 there (SCP-2400, SCP-2275, SCP-2140, SCP-3309) is the strongest unmined material available.
